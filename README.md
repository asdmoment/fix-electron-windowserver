...
3. 每 10 秒检查这些应用的窗口，通过 CoreGraphics 私有 API 禁用窗口阴影
4. 新安装的 Electron 应用会在下次扫描时自动识别
...
```bash
git clone https://github.com/biliacat/fix-electron-windowserver.git
